...
const TechBadge = ({ name }) => (
  <span className="px-2 sm:px-3 py-1 text-xs font-medium bg-black/70 text-white border border-gray-700 rounded-full transition-all duration-300 hover:bg-white/10 hover:border-white/30">
    {name}
  </span>
);
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-4 sm:p-5 md:p-6 z-10">
        ...
        <div className={`mt-3 sm:mt-6 transition-all duration-500 ${
          ...
          <span 
            className="inline-flex items-center text-white hover:text-gray-300 pb-1 transition-all font-medium text-sm sm:text-base"
    ...
    <section className="py-2 bg-transparent">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center gap-4 sm:gap-6 md:gap-8">
          ...
          <div className="w-full grid grid-cols-1 lg:grid-rows-2 gap-4 sm:gap-6 md:gap-8">
